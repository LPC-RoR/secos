...
class NivelFormacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nivel_formacion" do
    assert_difference('NivelFormacion.count') do
      post nivel_formaciones_url, params: { nivel_formacion: { descripcion: @nivel_formacion.descripcion, fecha_inicio: @nivel_formacion.fecha_inicio, fecha_obtencion: @nivel_formacion.fecha_obtencion, nivel_en_formacion: @nivel_formacion.nivel_en_formacion, titulo_grado: @nivel_formacion.titulo_grado } }
    end
  ...
  test "should update nivel_formacion" do
    patch nivel_formacion_url(@nivel_formacion), params: { nivel_formacion: { descripcion: @nivel_formacion.descripcion, fecha_inicio: @nivel_formacion.fecha_inicio, fecha_obtencion: @nivel_formacion.fecha_obtencion, nivel_en_formacion: @nivel_formacion.nivel_en_formacion, titulo_grado: @nivel_formacion.titulo_grado } }

...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post mensajes_url, params: { mensaje: { detalle: @mensaje.detalle, email: @mensaje.email, estado: @mensaje.estado, fecha_envio: @mensaje.fecha_envio, mensaje: @mensaje.mensaje, perfil_id: @mensaje.perfil_id, tipo: @mensaje.tipo } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { detalle: @mensaje.detalle, email: @mensaje.email, estado: @mensaje.estado, fecha_envio: @mensaje.fecha_envio, mensaje: @mensaje.mensaje, perfil_id: @mensaje.perfil_id, tipo: @mensaje.tipo } }

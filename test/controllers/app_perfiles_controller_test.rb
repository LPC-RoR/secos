...
class AppPerfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_perfil" do
    assert_difference('AppPerfil.count') do
      post app_perfiles_url, params: { app_perfil: { administrador_id: @app_perfil.administrador_id, email: @app_perfil.email, usuario_id: @app_perfil.usuario_id } }
    end
  ...
  test "should update app_perfil" do
    patch app_perfil_url(@app_perfil), params: { app_perfil: { administrador_id: @app_perfil.administrador_id, email: @app_perfil.email, usuario_id: @app_perfil.usuario_id } }

...
class SbElementosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sb_elemento" do
    assert_difference('SbElemento.count') do
      post sb_elementos_url, params: { sb_elemento: { acceso: @sb_elemento.acceso, activo: @sb_elemento.activo, elemento: @sb_elemento.elemento, nivel: @sb_elemento.nivel, orden: @sb_elemento.orden, sb_lista_id: @sb_elemento.sb_lista_id, tipo: @sb_elemento.tipo } }
    end
  ...
  test "should update sb_elemento" do
    patch sb_elemento_url(@sb_elemento), params: { sb_elemento: { acceso: @sb_elemento.acceso, activo: @sb_elemento.activo, elemento: @sb_elemento.elemento, nivel: @sb_elemento.nivel, orden: @sb_elemento.orden, sb_lista_id: @sb_elemento.sb_lista_id, tipo: @sb_elemento.tipo } }

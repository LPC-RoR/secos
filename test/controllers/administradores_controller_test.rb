...
class AdministradoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradores_url, params: { administrador: { administrador: @administrador.administrador, email: @administrador.email, usuario_id: @administrador.usuario_id } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { administrador: @administrador.administrador, email: @administrador.email, usuario_id: @administrador.usuario_id } }

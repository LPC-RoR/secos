...
class SbListasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sb_lista" do
    assert_difference('SbLista.count') do
      post sb_listas_url, params: { sb_lista: { acceso: @sb_lista.acceso, activa: @sb_lista.activa, lista: @sb_lista.lista } }
    end
  ...
  test "should update sb_lista" do
    patch sb_lista_url(@sb_lista), params: { sb_lista: { acceso: @sb_lista.acceso, activa: @sb_lista.activa, lista: @sb_lista.lista } }

...
class AppDocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_documento" do
    assert_difference('AppDocumento.count') do
      post app_documentos_url, params: { app_documento: { app_directorio_id: @app_documento.app_directorio_id, app_repo_id: @app_documento.app_repo_id, documento: @app_documento.documento, publico: @app_documento.publico } }
    end
  ...
  test "should update app_documento" do
    patch app_documento_url(@app_documento), params: { app_documento: { app_directorio_id: @app_documento.app_directorio_id, app_repo_id: @app_documento.app_repo_id, documento: @app_documento.documento, publico: @app_documento.publico } }
